...
var Html5QrcodeScanner = function() {
  ...
  return _createClass(a, [{
    ...
    value: function(a) {
      var b = document.createElement("div");
      b.style.textAlign = "left", b.style.margin = "0px", b.style.padding = "5px", b.style.fontSize = "20px", b.style.borderBottom = "0px solid rgba(192, 192, 192, 0.18)", a.appendChild(b);
    ...
    value: function() {
      ...
      g.innerHTML = "Start camera", g.addEventListener("click", function() {
    ...
    value: function() {
      ...
      }, this.cameraScanImage.width = 300, this.cameraScanImage.src = a.ASSET_CAMERA_SCAN)
    }
  }, {
