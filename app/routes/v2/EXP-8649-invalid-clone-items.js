module.exports = function(router) {
  ...
  const base_url = version + "/EXP-8649-invalid-clone-items"
  ...
  router.post('/'+base_url+'*/clone', function(req, res) {
    ...
    if(req.body.application_type =="clone"){
      ...
      res.redirect(301, '/' + base_url +req.params[0]+ '/certificate/cloned-confirmation?certificate=ehc6969&alert=cloned&copy_as_new='+copy);
    }else{
